  ...
  const onCreateWorkspace = useCallback(
    (e) => {
      ...
      if (!newWorkspace || !newWorkspace.trim()) {
        toast.warn('워크스페이스 이름을 입력해주세요', { position: 'bottom-center' });
        return;
      }
      if (!newUrl || !newUrl.trim()) {
        toast.warn('워크스페이스 url 을 입력해주세요', { position: 'bottom-center' });
        return;
      }
      axios
        .post(
